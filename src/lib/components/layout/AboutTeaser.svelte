...
<script lang="ts">
	...
	name: "Lisa Wehden",
	role: "Founder",
	image: "/generated/image-a-friendly-professional-woman-founder-in.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`“We started Plymouth because extraordinary talent should not get stuck behind bureaucracy.”`}
    />
